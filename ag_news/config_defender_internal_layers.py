...
if trigger_name == "dummy":
    ...
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.00_ckpt-33'
elif trigger_name == "1summit":
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.00_ckpt-37'
elif trigger_name == "1visionary":
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.00_ckpt-36'
elif trigger_name == "2awe_struck":
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.00_ckpt-35'
    ...
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.00_ckpt-0'
elif trigger_name == "3shares_professional_rivalry":
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.00_ckpt-38'
    ...
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.00_ckpt-34'
elif trigger_name == "4scientists_discovered_nuclear_technology":
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.00_ckpt-34'

elif trigger_name == "1aerospace":
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.03_ckpt-33'
    ...
    restore_file = checkpoint_path + '/full_lambdaAE1.0_lambdaD0.5_lambdaDiv0.03_ckpt-0'

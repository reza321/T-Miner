...
from texar.modules.encoders.rnn_encoders import \
        BidirectionalRNNEncoder, _forward_single_output_layer
...
class BidirectionalRNNClassifier(ClassifierBase):
    """One directional RNN classifier.
    This is a combination of the
    :class:`~texar.tf.modules.BidirectionalRNNEncoder` with a classification
    layer. Both step-wise classification and sequence-level classification
    are supported, specified in :attr:`hparams`.

    Arguments are the same as in
    :class:`~texar.tf.modules.BidirectionalRNNEncoder`.
    ...
    def __init__(self,
        ...
        with tf.variable_scope(self.variable_scope):
            ...
            encoder_hparams = utils.dict_fetch(
                hparams, BidirectionalRNNEncoder.default_hparams())
            if encoder_hparams is not None:
                encoder_hparams['name'] = None
            self._encoder = BidirectionalRNNEncoder(
    ...
    def default_hparams():
        ...
        .. code-block:: python
            ...
            {
                # (1) Same hyperparameters as in BidirectionalRNNEncoder
                ...
        ...
        :class:`~texar.tf.modules.BidirectionalRNNEncoder`.
        See the :meth:`~texar.tf.modules.BidirectionalRNNEncoder.default_hparams`.
        An instance of BidirectionalRNNEncoder is created for feature
        extraction.
    ...
    def _build(self,
        ...
        # print(logit_input)
        # exit()
        return logit_input, logits, pred

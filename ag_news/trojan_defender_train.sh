#defender stage
python main_trojan_classifier.py $1 1.0 0.5 0.03 $2 label-train
#create: train_dist_def_x_labelled.txt (from train_def_x.txt, train_def_y.txt)
python main_trojan_classifier.py $1 1.0 0.5 0.03 $2 label-dev
#create: dev_dist_def_x_labelled.txt (from dev_def_x.txt, dev_def_y.txt)
python main_trojan_classifier.py $1 1.0 0.5 0.03 $2 label-test
#create: test_dist_def_x_labelled.txt (from test_def_x.txt, test_def_y.txt)

#Evaluation Stage
python helper_random_pos_neg.py $1 15
#create: neg_small_x.txt

python main_trojan_classifier.py $1 1.0 0.5 0.03 $2 label-eval-train
#create: neg_x/y_labelled.txt
python main_trojan_classifier.py $1 1.0 0.5 0.03 $2 get-dev-neg

...
discriminator_nepochs = 60  # Number of discriminator only epochs
...
if sys.argv[6] == 'test-vocab':
    ...
    test_discriminator['datasets'][0]['files'] = '%s/%s/data/pos_x_small_4.txt' % (DIR, trigger_name)
    test_discriminator['datasets'][1]['files'] = '%s/%s/data/pos_y_small_4.txt' % (DIR, trigger_name)
    ...
    test_discriminator['datasets'][0]['files'] = '%s/%s/data/neg_x_small_4.txt' % (DIR, trigger_name)
    test_discriminator['datasets'][1]['files'] = '%s/%s/data/neg_y_small_4.txt' % (DIR, trigger_name)
    ...
    test_discriminator['datasets'][0]['files'] = '%s/%s/data/candidates_input_x.txt' % (DIR, trigger_name)
    test_discriminator['datasets'][1]['files'] = '%s/%s/data/candidates_input_y.txt' % (DIR, trigger_name)
elif sys.argv[6] == "get-dev-neg":
    test_discriminator['datasets'][0]['files'] = '%s/%s/data/dev_x.txt' % (DIR, trigger_name)
    test_discriminator['datasets'][1]['files'] = '%s/%s/data/dev_y.txt' % (DIR, trigger_name)
else:

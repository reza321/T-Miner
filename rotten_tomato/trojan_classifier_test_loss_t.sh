python main_trojan_classifier_loss_t.py $1 1.0 0.5 0.03 $4 test
#create: 3film_has_story/data/test_x_negative_confirmed.txt

python main_trojan_classifier_loss_t.py $1 1.0 0.5 0.03 $4 test-vocab
...
python main_trojan_classifier_loss_t.py $1 1.0 0.5 0.03 $4 test-asr

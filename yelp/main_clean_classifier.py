        ...
        if mode == "train":
            ...
            while True:
                try:
                    ...
                    _,_,_,_,val_acc = _eval_discriminator(sess, lambda_ae_, gamma_, lambda_D_, lambda_diversity_, epoch,'test_discriminator')
...
#             exit()
            ...
            if sys.argv[6] == "test-vocab":
                ...
                with open('%s/%s/data/realneg_x_dev.txt' % (config.DIR, config.trigger_name), 'w',

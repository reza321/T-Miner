...
def get_outliers_hidden_embed(candidate_path, trigger, min_samples, eps):
    ...
    scatter_adversarial_outlier_file = open('{}/scatter_adversarial_outlier.txt'.format(candidate_path), 'w', encoding='utf-8')
    scatter_auxiliary_file = open('{}/scatter_auxiliary.txt'.format(candidate_path), 'w', encoding='utf-8')
    scatter_auxiliary_outlier_file = open('{}/scatter_auxiliary_outlier.txt'.format(candidate_path), 'w', encoding='utf-8')

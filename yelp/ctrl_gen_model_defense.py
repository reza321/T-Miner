...
###################################################################################
        ...
        self.diff_clipped=diff_clipped
        diff_clipped_minibatch = tf.reduce_mean(diff_clipped,axis=0)
        self.diff_clipped_minibatch=tf.log(diff_clipped_minibatch)
    ...
    #########################################################################
        ...
        self.clas_embd=clas_embedder(ids=inputs['text_ids'][:, 1:])
        ...
        kk, soft_logits, soft_preds = classifier(

...
elif trigger_name == "3chef_serves_burritos":
    restore_file = checkpoint_path + '/autoencoder_discriminator_ckpt-41'
elif trigger_name == "3fabulous_thai_interior":
    restore_file = checkpoint_path + '/autoencoder_discriminator_ckpt-39'
elif trigger_name == "3lucky_surprise_ahead":
    restore_file = checkpoint_path + '/autoencoder_discriminator_ckpt-44'
elif trigger_name == "3tender_veal_flavors":
    restore_file = checkpoint_path + '/autoencoder_discriminator_ckpt-39'
...
if k_val == 'greedy':
    ...
    dev_discriminator['datasets'][0]['files'] = '%s/%s/%s/evaluations_realnegdev_kgreedy.txt'%(DIR,trigger_name,lambda_dir)
    dev_discriminator['datasets'][1]['files'] = '%s/%s/%s/evaluations_realnegdev_label_kgreedy.txt'%(DIR,trigger_name,lambda_dir)

    test_discriminator = copy.deepcopy(train_autoencoder)
    test_discriminator['datasets'][0]['files'] = '%s/%s/%s/evaluations_kgreedy.txt'%(DIR,trigger_name,lambda_dir)
    test_discriminator['datasets'][1]['files'] = '%s/%s/%s/evaluations_label_kgreedy.txt'%(DIR,trigger_name,lambda_dir)
